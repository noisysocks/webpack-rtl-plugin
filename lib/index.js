...
var WebpackRTLPlugin = function WebpackRTLPlugin() {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { filename: false, suffix: false, options: {}, plugins: [] };
      ...
      chunk.files.forEach(function (asset) {
        if (_path2.default.extname(asset) === '.css') {
          ...
          if (_this.options.filename) {
            ...
            var suffix = _this.options.suffix || '.rtl';
            var newFilename = '' + _path2.default.basename(asset, '.css') + suffix;
